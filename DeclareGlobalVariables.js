...
var prayersLanguages = ['COP', 'FR', 'CA', 'AR'], readingsLanguages = ['AR', 'FR', 'EN'], PrayersArray = [], ReadingsArray = [], PraxisArray = [], KatholikonArray = [], StPaulArray = [], SynaxariumArray = [], GospelMassArray = [], GospelVespersArray = [], GospelDawnArray = [], GospelNightArray = [], PropheciesDawnArray = [], ReadingsArray = [], GospelResponse = '', PsalmResponse = '', lastClickedButton;
const Readings = {
    BibleIntroFR: '',
